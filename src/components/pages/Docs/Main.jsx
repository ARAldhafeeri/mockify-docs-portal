...
export default function Docs() {
  return (
    <>
      ...
      <img src={withoutImage} alt="implmentation-first" width={400}  className='m-5 drop-shadow-xl p-2 rounded-xl bg-[#7a7a7a]'/>
      ...
      <h1 className='text-[#c4c4c4] text-base font-bold'>Advantages</h1>
      <ul className='list-disc list-inside'>
        <li className='text-[#c4c4c4] text-sm font-bold'>Quick start and Flexibility</li>
        <li className='text-[#c4c4c4] text-sm font-bold'>Iterative development without API constraints</li>
      </ul>
      <h1 className='text-[#c4c4c4] text-base font-bold'>Disadvantages</h1>
      <ul className='list-disc list-inside'>
        <li className='text-[#c4c4c4] text-sm font-bold'>potential for inconsistencies and lack of documentation</li>
        <li className='text-[#c4c4c4] text-sm font-bold'>Collaboration challenges for third-party developers</li>
        <li className='text-[#c4c4c4] text-sm font-bold'>Lack of Clarity in design</li>
      </ul>
      <h1>API First</h1>
      <img src={withImage} alt="implmentation-first" width={400}  className='m-5 drop-shadow-xl p-2 rounded-xl bg-[#7a7a7a]'/>
      ...
      <h1 className='text-[#c4c4c4] text-base font-bold'>Advantages</h1>
      <ul className='list-disc list-inside'>
        <li className='text-[#c4c4c4] text-sm font-bold'>Enhanced team collaboration and concurrent development</li>
        <li className='text-[#c4c4c4] text-sm font-bold'>Well-defined interface from the outset</li>
      </ul>
      <h1 className='text-[#c4c4c4] text-base font-bold'>Disadvantages</h1>
      <ul className='list-disc list-inside'>
        <li className='text-[#c4c4c4] text-sm font-bold'>New design approach may be resisted</li>
        <li className='text-[#c4c4c4] text-sm font-bold'>Changes to actual APIs may require chante to mock apis - solution : just create new mock APIs.</li>
      </ul>
      
      <Divider />
      <h1>Products</h1>
      <div className='grid gap-8 grid-flow-row-dense md:grid-cols-2 grid-cols-1 w-[15rem] h-96 md:w-[54rem] md:h-96'>
        <DocCard
          h1="Manage Mockify Users"
          icon={<AiOutlineUserSwitch size={40} color="#7a7a7a" />}
        ...
        <DocCard
          ...
          icon={<AiTwotoneProject size={40} color="#7a7a7a" />}
        ...
        <DocCard
          ...
          icon={<AiFillDingtalkSquare size={40} color="#7a7a7a" />}
        ...
        <DocCard
          h1="Manage Mock Data"
          icon={<AiTwotoneDatabase size={40} color="#7a7a7a" />}
        ...
        <DocCard
          h1="Dynamic Policies"
          icon={<AiTwotoneControl size={40} color="#7a7a7a" />}
        ...
        <DocCard
          ...
          icon={<AiTwotoneApi size={40} color="#7a7a7a" />}
        ...
        <DocCard
          h1="Edge Functions"
          icon={<AiOutlineFundProjectionScreen size={40} color="#7a7a7a" />}
        ...
        <DocCard
          ...
          icon={<AiOutlineDeploymentUnit size={40} color="#7a7a7a" />}
